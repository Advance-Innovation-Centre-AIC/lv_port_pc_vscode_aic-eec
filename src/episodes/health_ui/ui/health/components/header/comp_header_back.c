#include "comp_header_back.h"

#include "../../layout/layout_fonts.h"
#include "../../layout/layout_tokens.h"

lv_obj_t *comp_header_back_create(lv_obj_t *parent, const char *title,
                                  const char *subtitle) {
  lv_obj_t *panel;
  ...
  lv_label_set_text_fmt(title_label, LV_SYMBOL_LEFT "  %s",
                        (NULL != title) ? title : "Back Header");
