...
void health_ui_sim_data_init(void) {
  ...
  /* Overwrite compile-time placeholder names with i18n strings. */
  s_member_names[0]  = _(STR_MEMBER_0);
  s_member_names[1]  = _(STR_MEMBER_1);
  s_member_names[2]  = _(STR_MEMBER_2);
  s_member_names[3]  = _(STR_MEMBER_3);
  s_member_names[4]  = _(STR_MEMBER_4);
  s_member_names[5]  = _(STR_MEMBER_5);
  s_member_names[6]  = _(STR_MEMBER_6);
  s_member_names[7]  = _(STR_MEMBER_7);
  s_member_names[8]  = _(STR_MEMBER_8);
  s_member_names[9]  = _(STR_MEMBER_9);
}
