 ...
 * File Name:   gpio.h
 *
 * Description: AIC-EEC GPIO Hardware Abstraction Layer - PC Simulator Mock Version
...
typedef enum {
    AIC_LED_RED = 0,    /**< User LED 1 (Red) */
    AIC_LED_GREEN,      /**< User LED 2 (Green) */
    AIC_LED_BLUE,       /**< User LED 3 (Blue) */
 ...
 * @param btn Button identifier
 * @return Button name string (e.g., "User", "User2")
 */
...
/**
 * @brief Set simulated button state (for UI/keyboard control)
 * @param btn Button identifier
 * @param pressed true = pressed, false = released
 * @note This function also sets the was_pressed flag and triggers callback
 */
