 ...
 */
typedef struct {
    int16_t value;          /**< Temperature in 0.01C */
...
/*******************************************************************************
 * FreeRTOS Task (Internal) - No-op on PC Simulator
 ******************************************************************************/

/**
 * @brief Create event processing task (no-op on PC)
 */
void aic_event_create_task(void);

/**
 * @brief Delete event processing task (no-op on PC)
 */
void aic_event_delete_task(void);

/**
 * @brief Process event queue (call from main loop or LVGL timer on PC)
 */
